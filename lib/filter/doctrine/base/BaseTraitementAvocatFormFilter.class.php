...
/**
 * TraitementAvocat filter form base class.
 *
 * @package    juriste
 * @subpackage filter
 ...
 */
abstract class BaseTraitementAvocatFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'id_agent'             => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'id_agent'             => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
    ...
    $this->widgetSchema->setNameFormat('traitement_avocat_filters[%s]');
