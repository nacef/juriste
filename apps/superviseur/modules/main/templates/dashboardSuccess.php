<div id="main_content_wrap" class="container_12">
  ...
  <div id="icondock" class="grid_12">
    <ul>
      <li><a href="<?php echo url_for('vente/index') ?>" rel="tipsy" title="Ventes"><img SRC="/images/icondock/coins.png" alt="Ventes" /><br />Ventes</a></li>
      <li><a href="<?php echo url_for('rdv/index') ?>" rel="tipsy" title="RDVs"><img SRC="/images/icondock/date.png" alt="Events" /><br />RDVs</a></li>
